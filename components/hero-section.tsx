    ...
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center pt-24 pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            <h1 className="text-5xl sm:text-6xl md:text-[80px] lg:text-[90px] font-heading font-extrabold text-[#021B0F] tracking-tighter leading-[0.95] mb-6 uppercase flex flex-col items-start relative">
              <span className="text-brand-lime">KNOW YOUR SOIL,</span>
              <span className="flex items-center text-brand-lime">
                GROW YOUR YIELD.
                {/* Small leaf decorative icon near title */}
                <Leaf className="w-12 h-12 md:w-16 md:h-16 ml-2 text-brand-lime fill-brand-lime -mt-4 rotate-12" />
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-10">
              ...
              <Button variant="outline" className="w-full sm:w-auto h-14 md:h-16 px-8 border-transparent bg-white hover:bg-zinc-50 text-[#102117] rounded-[16px] text-lg font-bold uppercase tracking-wider font-heading transition-all shadow-md hover:-translate-y-1">
                <Play className="mr-2.5 h-5 w-5 fill-[#102117] text-[#102117]" /> Watch Demo
              </Button>
            </div>
            ...
            <div className="flex bg-white px-6 py-4 rounded-2xl shadow-lg border border-[#EBF1EC] items-center gap-8 md:gap-12 w-full max-w-[480px]">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xl md:text-2xl font-black text-[#102117] font-heading leading-tight">99.8%</span>
                  <span className="text-[10px] md:text-xs text-[#5B665E] uppercase tracking-widest font-bold">Accuracy</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-lg md:text-xl font-black text-[#102117] font-heading uppercase leading-tight tracking-tight">Farmer</span>
                  <span className="text-[10px] md:text-xs text-[#5B665E] uppercase tracking-widest font-bold">Verified</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {/* Glowing AI Target Circle over the soil (simulated) */}
            <div className="absolute top-2/3 -left-10 md:left-0 w-32 h-32 rounded-full border border-brand-lime shadow-[0_0_40px_rgba(124,191,53,0.5)] flex items-center justify-center pointer-events-none">
              <div className="w-full h-full border border-brand-lime/50 rounded-full animate-ping opacity-20 absolute" />
              <div className="w-16 h-16 border-2 border-dashed border-brand-lime rounded-full animate-[spin_10s_linear_infinite]" />
              <div className="absolute w-2 h-2 bg-brand-lime rounded-full" />
              {/* Nodes */}
              <div className="absolute w-2 h-2 bg-red-500 rounded-full top-4 left-8 shadow-[0_0_8px_red]" />
              <div className="absolute w-2 h-2 bg-yellow-500 rounded-full bottom-6 right-8 shadow-[0_0_8px_yellow]" />
            </div>
